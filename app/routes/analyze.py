...
async def analyze_document(file_id: str):
    ...
    logger.info(f"Found file for analysis: {file_path}")

    # ---------------------------------------------------------------
    # 2. Извлекаем весь текст PDF
    # ---------------------------------------------------------------
    ...
    # ---------------------------------------------------------------
    # 4. Извлекаем текст ПОСТРАНИЦЕ
    # ---------------------------------------------------------------
    pages = extract_pdf_pages(file_path)
    logger.info(f"Extracted {len(pages)} pages")

    # ---------------------------------------------------------------
    # 5. Делаем чанки (для классификации)
    # ---------------------------------------------------------------
    ...
    # ---------------------------------------------------------------
    # 6. LLM-классификация (определение типа документа)
    # ---------------------------------------------------------------
